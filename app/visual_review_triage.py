    ...
    with connect() as con:
        ...
        if decision=="accept":
            ...
            if not reviewed_text:
                raise HTTPException(409,"Explicit human-reviewed verbatim text is required")
...
body{font-family:system-ui;background:#f5f7fb;margin:0;color:#172033}main{max-width:1300px;margin:auto;padding:16px}.box{background:#fff;border-radius:16px;padding:14px;margin:10px 0;box-shadow:0 3px 14px #0001}.top{display:flex;gap:8px;flex-wrap:wrap;align-items:center}.cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px}.card{padding:12px;border:1px solid #e4e7ec;border-radius:12px}.item{border:1px solid #e4e7ec;border-radius:14px;padding:12px;margin:10px 0}.muted{color:#667085;font-size:13px}.warn{color:#b54708}.bad{color:#b42318}.ok{color:#067647}.pill{display:inline-block;padding:5px 9px;border-radius:999px;background:#f2f4f7;margin:2px}textarea{width:100%;min-height:110px;box-sizing:border-box;padding:9px;border:1px solid #ccd2dd;border-radius:9px;font:inherit}input,button,select{padding:9px;border:1px solid #ccd2dd;border-radius:9px;font:inherit}button{cursor:pointer}.actions{display:flex;gap:7px;flex-wrap:wrap;margin-top:8px}.source{white-space:pre-wrap;background:#f8fafc;padding:10px;border-radius:10px}.suggestion{white-space:pre-wrap;background:#eef4ff;padding:10px;border-radius:10px}.source-img{display:block;max-width:100%;max-height:760px;object-fit:contain;border:1px solid #e4e7ec;border-radius:10px;background:#fff}@media(max-width:720px){main{padding:10px}.actions button{flex:1 1 45%}}</style><main>
...
@app.get("/admin/visual-review-triage", response_class=HTMLResponse, dependencies=[Depends(require_admin)])

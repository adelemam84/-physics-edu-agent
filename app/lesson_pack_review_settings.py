...
def _settings_page(job_id: str) -> str:
    ...
    safe_path_id = quote(job_id, safe="")
...
<div class=box><a href="/admin/lesson-pack-studio/jobs/''' + safe_path_id + r'''/preview">الرجوع لمعاينة الملزمة</a> · <a href="/admin/lesson-pack-studio">Lesson Pack Studio</a></div>

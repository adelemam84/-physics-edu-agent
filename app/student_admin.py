...
<h1>إدارة الطلاب والاختبارات</h1><div class="box row"><a href="/admin/dashboard">لوحة التحكم</a><a href="/admin/quiz-builder">منشئ الاختبارات</a></div>

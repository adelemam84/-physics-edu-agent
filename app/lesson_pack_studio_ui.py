...
.ok{color:#067647}.warn{color:#b54708}.bad{color:#b42318}.muted{color:#667085;white-space:pre-wrap}.q{border:1px solid #e4e7ec;border-radius:10px;padding:10px;margin:8px 0}details{margin-top:8px}.preview-frame{width:100%;height:72vh;min-height:620px;border:1px solid #d0d5dd;border-radius:12px;background:#fff}.visual-card{border:1px solid #e4e7ec;border-radius:12px;padding:10px}.visual-card img{width:100%;max-height:300px;object-fit:contain;background:#fafafa}.crop-grid{display:grid;grid-template-columns:repeat(4,minmax(70px,1fr));gap:6px}.crop-grid input{width:100%}.action-row{display:flex;gap:8px;flex-wrap:wrap}.action-row button{width:auto}
...
<div class=box><h2>معاينة A4 قبل التصدير</h2><p class=muted>هذه المعاينة تحمل علامة «غير معتمدة» ويمكن فتحها قبل الاعتماد النهائي. التصدير النهائي يظل مقفولًا حتى اعتماد المدرس.</p><div class=action-row><button id=studentPreview>معاينة نسخة الطالب</button><button id=teacherPreview>معاينة نسخة المدرس</button></div><p><iframe id=pdfPreview class=preview-frame title="معاينة PDF"></iframe></p></div>
...
pdfPreview.src='/api/admin/lesson-pack-studio/jobs/'+id+'/preview-pdf?edition=student&v='+Date.now();
studentPdf.href='/api/admin/lesson-pack-studio/jobs/'+id+'/export-pdf?edition=student';teacherPdf.href='/api/admin/lesson-pack-studio/jobs/'+id+'/export-pdf?edition=teacher';studentPdf.style.opacity=teacherPdf.style.opacity=data.teacher_approved?'1':'.45';studentPdf.style.pointerEvents=teacherPdf.style.pointerEvents=data.teacher_approved?'auto':'none';}
...
studentPreview.onclick=()=>{pdfPreview.src='/api/admin/lesson-pack-studio/jobs/'+id+'/preview-pdf?edition=student&v='+Date.now()};
teacherPreview.onclick=()=>{pdfPreview.src='/api/admin/lesson-pack-studio/jobs/'+id+'/preview-pdf?edition=teacher&v='+Date.now()};

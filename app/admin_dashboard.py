...
</style><div class=layout><aside class=side><h2>منصة العلوم التعليمية</h2><a href="/admin/dashboard">الرئيسية</a><a href="/admin/workflow">مراجعة الأسئلة</a><a href="/admin/academic">الهيكل الأكاديمي</a><a href="/admin/bank">بنك الأسئلة</a><a href="/admin/quiz-builder">إنشاء اختبار</a><a href="/admin/students">الطلاب والاختبارات</a><a href="/admin/parents">أولياء الأمور وواتساب</a><a href="/admin/progress">متابعة التقدم</a><a href="/admin/readiness">جاهزية النظام</a><a href="/admin/diagnostics">تشخيص سلامة البيانات</a><a href="/student">بوابة الطالب</a><a href="/practice">معاينة الطالب</a></aside><main class=main>

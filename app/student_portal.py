...
def student_portal(student_code:str):
    ...
    return {"student":st,"attempts":attempts,"errors":errors,"available_quizzes":available,"current_curriculum":current_curriculum,"mastery":mastery,"remedial_progress":remedial,"learning_recommendations":learning,"adaptive":adaptive,

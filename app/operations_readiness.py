...
def build_operations_readiness() -> dict:
    ...
    return {
        ...
        "metrics": {
            ...
            "ai_retried_calls_24h": int(ai_summary.get("retried_calls") or 0),
            "ai_retry_attempts_24h": int(ai_summary.get("retry_attempts") or 0),
            "ai_retry_pct_24h": float(ai_summary.get("retry_pct") or 0.0),

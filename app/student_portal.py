...
def student_portal(student_code:str):
    ...
    return {"student":st,"attempts":attempts,"errors":errors,"available_quizzes":available,"adaptive":adaptive,

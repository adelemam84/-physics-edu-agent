...
def student_portal(student_code:str):
    ...
    with connect() as con:
        ...
        available=list(con.execute("""SELECT q.id,q.title,q.duration_minutes,q.quality_score,q.published_at,

...
def feature_status_snapshot() -> dict:
    ...
    items = [
        ...
        },
        {
            ...
            "path": "/admin/exam-engine",
            "detail": "أكواد دخول وجدولة ونزاهة الامتحان" if (_has("/api/admin/exams") or _has("/admin/exam-engine")) else "المسار غير مسجل في Runtime",
        },
        {
            "id": "exam_diagnostics",
            "name": "تشخيص نتائج المحاولات",
            "state": "active" if "/api/admin/attempts/{attempt_id}/diagnostic" in routes else "needs_attention",
            "path": "/admin/progress",
            "detail": "تحليل أخطاء المحاولة ونقاط الضعف من النتائج الفعلية",
        },
        {
            "id": "advanced_exam_analytics",
            "name": "تحليلات الامتحان المتقدمة",
            "state": "active" if "/api/admin/exams/{quiz_id}/advanced-analytics" in routes else "needs_attention",
            "path": "/admin/exam-analytics",
            "detail": "اتجاهات الطلاب والزمن وإشارات مراجعة توازن الأسئلة",
        },
        {
            "id": "study_intelligence",
            "name": "Study Intelligence",
            "state": "active" if "/api/admin/students/{student_id}/study-queue" in routes else "needs_attention",
            "path": "/admin/students",
            "detail": "قائمة مذاكرة شخصية وتطور نقاط الضعف بمصادر معتمدة فقط",
        },
        {
            "id": "score_override_audit",
            "name": "تدقيق تعديل الدرجات",
            "state": "active" if "/api/admin/attempts/{attempt_id}/score-history" in routes else "needs_attention",
            "path": "/admin/progress",
            "detail": "أي تعديل يدوي للدرجة يحتفظ بالسبب والسجل السابق للمراجعة",
        },
        {
            "id": "lesson_studio",
            "name": "Lesson Studio",

...
def student_portal(student_code:str):
    ...
    from .analytics import _student_mastery,_remedial_progress
    with connect() as con:
    ...
    return {"student":st,"attempts":attempts,"errors":errors,"available_quizzes":available,"mastery":mastery,"remedial_progress":remedial,"adaptive":adaptive,

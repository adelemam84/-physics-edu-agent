...
def system_readiness():
    ...
    elif db["unassigned_documents"]>0: actions.append({"title":f'إعادة تصنيف {db["unassigned_documents"]} ملف PDF قديم داخل المنهج الصحيح',"path":"/admin/document-recovery","owner":"user"})
